...
- Added alert to Configuration Page for updated functionality
- Added Version Alert to Configuration Page
- Added Version Alert ot Admin Modal
- Added ability to dismiss version alerts
...
- Added Site Settings section to Admin UI
- Added "Allow duplicate name generation" setting
- Updated Generate page to check for duplicate name generation setting
